...
//  полноценное левостороннее (по желанию можно обычное) 
//  красно-черное дерево. И реализовать в нем метод добавления 
...
// после добавления элемента в дерево необходимо произвести 
// балансировку, благодаря которой все критерии выше станут 
// валидными. Для балансировки существует 3 операции – левый 
...
public class RedBlackTree<K extends Comparable<K>, V> implements Iterable<RedBlackTree<K, V>.Entry<K, V>>{
    ...
    public abstract class Entry<key, v> {
        public abstract K key();
        public abstract V value();
    }

    private class Node<key, value> extends Entry<K, V> {
        K key;
        V value;
        Node<K, V> left;
        Node<K, V> right;
